...
exports.codeDemoDefaultSetting = exports.codeDemoRender = void 0;
const hash = require("hash-sum");
const codeDemoRender = (tokens, idx) => {
...
exports.codeDemoRender = codeDemoRender;
exports.codeDemoDefaultSetting = {
    jsLib: [],
    cssLib: [],
    codepenLayout: "left",
