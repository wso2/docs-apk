...
const resolveThemeConfig = (themeConfig) => {
    ...
    if (!vuepress_shared_1.checkLang(baseLang))
        throw new Error("Base lang not supported. Make a PR to https://github.com/vuepress-theme-hope/vuepress-theme-hope/blob/v1/packages/shared/src/i18n/config.ts first!");
