...
const renderAtom = (feed) => {
    ...
    const content = {
        ...
        feed: {
            ...
            generator: utils_1.generator,
            link: [{ _attributes: { rel: "self", href: utils_1.encodeXML(links.atom) } }],
        },
    };
    if (channel.link)
    ...
    feed.items.forEach((item) => {
        ...
        if (Array.isArray(item.author)) {
            ...
            item.author.forEach((author) => {
                // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
                if (author.name)
                    entry.author.push(genAuthororContributor(author));
            });
        }
        // category
