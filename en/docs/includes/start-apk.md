...
```
helm install apk wso2apk/apk-helm --version 1.3.0 -f https://raw.githubusercontent.com/wso2/apk/refs/tags/1.3.0/helm-charts/samples/apk/1.3.0-qsg-values.yaml
```
