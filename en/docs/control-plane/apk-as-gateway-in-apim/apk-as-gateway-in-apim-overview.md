...
You can refer the [Quick Start Guide](apk-as-gateway-in-apim-qsg.md) regards to trying out API Manager Control Plane with APK Gateway using APIM-APK Agent.
