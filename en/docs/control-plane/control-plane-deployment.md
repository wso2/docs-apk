# Deploy APIM Control Plane with Kubernetes Gateway

There are 3 components that you need to deploy to get the Kubernetes Gateway working with APIM. They are:
