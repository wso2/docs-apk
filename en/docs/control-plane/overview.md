...
You can refer the [Setup](../control-plane/control-plane-deployment.md) regards to configuring API Manager Control Plane with APK Gateway using APIM-APK Agent.
