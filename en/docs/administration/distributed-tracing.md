...
To set up distributed tracing, start by following the instructions outlined in the <a href="../../setup/Customize-Configurations" target="_blank">customize configurations</a> section. These instructions will guide you through the process of acquiring the `values.yaml` file, which you will then use to tailor the tracing configurations to your specific needs.
