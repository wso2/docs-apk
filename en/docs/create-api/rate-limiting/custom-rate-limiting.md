...
Refer to the [custom-ratelimit-interceptor-service](https://github.com/wso2/apk/tree/main/samples/custom-ratelimit-interceptor-service) sample resources in APK repo.
