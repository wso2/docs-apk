...
=== "Command"
    ```
    helm install apim-apk-agent wso2/apim-apk-agent --version 1.2.0-rc --set wso2.subscription.imagePullSecrets="apk-registry-secret"
    ```
=== "Format"
    ```
...
=== "Command"
    ```
    helm install apim-apk-agent wso2/apim-apk-agent --version 1.2.0-rc --set image.tag="1.2.0.0-arm64" --set wso2.subscription.imagePullSecrets="apk-registry-secret"
    ```
=== "Format"
    ```
...
!!! Optional
    ...
    === "Command"
         ```
         helm install apim-apk-agent wso2/apim-apk-agent --version 1.2.0-rc -set wso2.subscription.imagePullSecrets="apk-registry-secret" -f values.yaml
         ```
    === "Format"
         ```
