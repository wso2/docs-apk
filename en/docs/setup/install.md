...
- <a href="../../setup/deployment/apk-with-apim-cp-deployment-patterns" target="_blank">Pattern 3</a> - <b>Kubernetes Gateway with Control Plane</b></a> <p>**Note:** In this pattern, **you cannot design or create APIs from the API Manager control plane**. API design should be handled by the Kubernetes Gateway. The created APIs will be reflected in the APIM UI to be governed and published.</p>
